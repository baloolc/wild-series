...
{
    const PROGRAM = [
        ['id' => 0, 'Title' => 'Walkingdead', 'Synopsis' => 'Des zombies envahissent la terre', 'Category' => 'Horreur', 'Country' => 'USA', 'Year' => '1999'],
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $program->setSlug($this->slugify->generate($programName['Title']));
