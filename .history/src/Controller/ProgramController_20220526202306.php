...
class ProgramController extends AbstractController
{
    ...
    public function new(Request $request, ProgramRepository $programRepository, CategoryRepository $ca): Response
    {
        $program = new Program();
        $form = $this->createForm(ProgramType::class, $program, CategoryType::class, $category);
