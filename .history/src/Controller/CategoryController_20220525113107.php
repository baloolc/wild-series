...
class CategoryController extends AbstractController
{
    ...
    public function show(string $ame, ProgramRepository $programRepository, CategoryRepository $categoryRepository ): Response
    {
        $category = $categoryRepository->findOneBy(['categoryName' => $categoryName]);
        if($category)
        {
