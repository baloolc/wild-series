...
class ProgramController extends AbstractController
{
    ...
    public function showSeason(int $seasonId, int $programId, ProgramRepository $programRepository, SeasonRepository $seasonRepository ): Response
    {
        ...
        $seasons = $seasonRepository->findOneBy(['season_id' => $seasonId]);
        if (!$seasons) {
            throw $this->createNotFoundException(
        ...
        return $this->render('program/show_.html.twig', [
            'program' => $program, 'seasons' => $seasons,
        ]);
    }
