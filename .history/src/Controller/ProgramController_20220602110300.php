...
class ProgramController extends AbstractController
{
    ...
    public function showSeason(Program $program, Season $season, Episode $episodes): Response
    {
        if (!$program) {
            throw $this->createNotFoundException(
                'No program with id : '. $program .' found in program\'s table.'
    ...
    #[Route('program/{slug}/season/{season}/episode/{episodeId}', name: 'program_episode_show')]
    public function showEpisode(Program $program, Season $season, Episode $episodeId): Response
    {
        return $this->render('program/episode_show.html.twig', [
            'program' => $program, 'season' => $season, 'episodeId' => $episodeId,
        ]);
    }
}
