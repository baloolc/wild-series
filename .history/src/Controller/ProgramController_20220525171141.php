...
class ProgramController extends AbstractController
{
    ...
    public function show(int $seasonId, int $programId, ProgramRepository $programRepository, SeasonRepository $seasonRepository ): Response
    {
        ...
        $seasons = $programRepository->findOneBy(['program_id' => $programId]);
        if (!$program) {
            throw $this->createNotFoundException(
                'No program with id : '.$programId.' found in program\'s table.'
            );
