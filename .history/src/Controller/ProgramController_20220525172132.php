...
class ProgramController extends AbstractController
{
    ...
    public function showSeason(int $seasonId, int $programId, ProgramRepository $programRepository, SeasonRepository $seasonRepository, EpisodeRepository $ep ): Response
    {
