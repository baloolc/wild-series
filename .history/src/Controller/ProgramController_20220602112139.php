...
class ProgramController extends AbstractController
{
    ...
    #[Route('program/{slug}/season/{seasonId}', name: 'program_show_season')]
    public function showSeason(Program $program, Season $seasonId, EpisodeRepository $episodeRepository): Response
    {
      $episodes = $episodeRepository->findBy(['season' => $season]);
        return $this->render('program/showSeason.html.twig', [
            'program' => $program, 'seasonId' => $seasonId, 'episodes' => $episodes,
        ]);
    }
